...
func (_Storage *StorageTransactor) SendTORunBa(opts *bind.TransactOpts, token common.Address, _to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Storage.contract.Transact(opts, "sendTORunBa", token, _to, _amount)
}

// SendTORunBa is a paid mutator transaction binding the contract method 0xc9f3935e.
//
// Solidity: function sendTORunBa(address token, address _to, uint256 _amount) returns()
func (_Storage *StorageSession) SendTORunBa(token common.Address, _to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.SendTORunBa(&_Storage.TransactOpts, token, _to, _amount)
}

// SendTORunBa is a paid mutator transaction binding the contract method 0xc9f3935e.
//
// Solidity: function sendTORunBa(address token, address _to, uint256 _amount) returns()
func (_Storage *StorageTransactorSession) SendTORunBa(token common.Address, _to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _Storage.Contract.SendTORunBa(&_Storage.TransactOpts, token, _to, _amount)
}
